...
# Sample data
RUN wget http://www.magentocommerce.com/downloads/assets/1.9.1.0/magento-sample-data-1.9.1.0.tar.gz
RUN mv magento-sample-data-1.9.1.0.tar.gz /tmp
RUN cd /tmp && tar -zxf magento-sample-data-1.9.1.0.tar.gz
...
RUN cd /tmp && tar -zxf magento-1.9.1.0.tar.gz
